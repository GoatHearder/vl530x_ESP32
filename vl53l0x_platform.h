...
//esp32 platfrom init
esp_err_t int_I2C_as_master(VL53L0X_DEV dev, gpio_num_t sda_gpio_pin, gpio_num_t scl_gpio_pin,
                            gpio_pullup_t sda_pullup, gpio_pullup_t scl_pullup, uint32_t clockspeed, i2c_port_t port, uint8_t address);
/**
 * @def PALDevDataGet
